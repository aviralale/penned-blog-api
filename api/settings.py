...
SECRET_KEY = "django-insecure-q7@$$akc%*y(+lyugp)-k8!=b=pr6^2s^t-*8c_0f6z$zz!uw6"
...
INSTALLED_APPS += ["rest_framework", "djoser", "accounts", "blog"]
...
MIDDLEWARE = [
    ...
    "blog.middleware.BlogViewMiddleware",
]
...
# ? NAMINGS
EMAIL_FRONTEND_SITE_NAME = "Penned"
